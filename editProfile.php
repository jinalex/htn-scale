                                ...
                                <rd-widget-body>
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <select ng-options="choice.choice_id as choice.choice_name for choice in data.playingLevels">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <p class="help-text">
                                                    <small>
                                                        Additional awards, titles, or accomplishments to showcase your playing strength. <i>(i.e. 5th Men's Singles at OFFSA, 3rd at Ryerson Open)</i> <strong>*Seperate by commmas!</strong>
                                                    </small>
                                                </p>
                                            </div>
                                        </div>
