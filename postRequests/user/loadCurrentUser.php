...
try {
    if ($user instanceof CurrentUser) {
        ...
        $sql = "SELECT user_id, username, reputation, date_registered, last_seen, email, avatar, commuter, level, program, avatar_link, bio FROM `users` WHERE user_id = '$profile_id'";
